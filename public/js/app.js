...
var _Scan = __webpack_require__(16);
...
var _items = __webpack_require__(52);

var _Items = __webpack_require__(53);
...
var Scan = function (_Component) {
  ...
  function Scan() {
    ...
    return _possibleConstructorReturn(this, (Scan.__proto__ || Object.getPrototypeOf(Scan)).apply(this, arguments));
  }
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _data.scanInfo.initials
        ),
        _react2.default.createElement(_Items.Items, { items: _items.items }),
        _react2.default.createElement('textarea', {
          placeholder: 'Save som JSON',
          defaultValue: JSON.stringify(_data.scanData.data)
        })
      );
    }
  }]);
...
exports.saveInterview = exports.scanData = exports.scanInfo = undefined;
...
var saveInterview = exports.saveInterview = function saveInterview(id, data) {
  _axios2.default.post('/scan/' + id + '/save', {
    data: data
...
var Items = exports.Items = function Items(_ref) {
  var items = _ref.items;
  return _react2.default.createElement(
    'ul',
    null,
    items.map(function (item) {
      return _react2.default.createElement(ItemContainer, { key: item.key, item: item });
    })
  );
};
...
var Item = function Item(_ref2) {
  var item = _ref2.item,
      ...
      interview = _ref2.interview;

  var isActive = item.key === interview.activeKey;
  return _react2.default.createElement(
    'li',
    { onClick: function onClick() {
        return dispatch((0, _actions.setActiveItem)(item.key));
      } },
    _react2.default.createElement(
      'div',
      null,
    ...
    isActive && _react2.default.createElement('input', {
      ...
      onChange: function onChange(event) {
        return dispatch((0, _actions.setResponse)(item.key, event.target.value));
      },
...
var ItemContainer = (0, _reactRedux.connect)(function (state) {
  return state;
})(Item);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_es_isPlainObject__ = __webpack_require__(80);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__connect_connect__ = __webpack_require__(73);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__mapStateToProps__ = __webpack_require__(89);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__mergeProps__ = __webpack_require__(90);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__selectorFactory__ = __webpack_require__(91);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_symbol_observable__ = __webpack_require__(77);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(63), __webpack_require__(78)(module)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__verifySubselectors__ = __webpack_require__(92);
function _objectWithoutProperties(obj, keys) { var target = {}; for (var i in obj) { if (keys.indexOf(i) >= 0) continue; if (!Object.prototype.hasOwnProperty.call(obj, i)) continue; target[i] = obj[i]; } return target; }
...
var _middlewares = __webpack_require__(95);
...
exports.default = function (persistedState) {
  var enhancer = (0, _redux.compose)((0, _redux.applyMiddleware)(_middlewares.loggerMiddleware), window.devToolsExtension());
...
var _interview = __webpack_require__(97);
...
var interview = function interview() {
  ...
  switch (action.type) {
    ...
    case 'SET_RESPONSE':
      return _extends({}, state, {
        responses: _extends({}, state.responses, _defineProperty({}, action.payload.key, action.payload.value))
      });
    default:
      return state;
  }
...
exports.setResponse = exports.setActiveItem = undefined;
...
var setActiveItem = exports.setActiveItem = function setActiveItem(key) {
  return {
...
var setResponse = exports.setResponse = function setResponse(key, value) {
  return {
    type: 'SET_RESPONSE',
    payload: {
      key: key,
...
var debounce = __webpack_require__(105),
